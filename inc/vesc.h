 ...
 * @brief VESC CAN controller communication implementation
 * @version 0.1
 * @date 2022-12-10
 *
...
class VescCAN
{
  ...
  public:
	 ...
	 * @brief Construct a new VESC CAN object
	 *
	 * @param can A pointer to a CANBus interface
	 * @param controllerId 8 bit controller id
	 */
	VescCAN(CANBus* can, uint8_t controllerId)
		: _can(can), _controllerId(controllerId)
	...
	/**
	 * @brief Test whether the received frame is a valid VESC frame and modifies the packet type with the received type
	 *
	...
	{
		static constexpr PacketId PacketId = PacketId::STATUS;
	...
	{
		static constexpr PacketId PacketId = PacketId::STATUS_2;
	...
	{
		static constexpr PacketId PacketId = PacketId::STATUS_3;
	...
	{
		static constexpr PacketId PacketId = PacketId::STATUS_4;
	...
	{
		static constexpr PacketId PacketId = PacketId::STATUS_5;
